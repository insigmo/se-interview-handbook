...
| [Binary search](../go/binary-search/binary-search_test.go)                                                                      | Классический алгоритм бинарного поиска                            | binary-search |
| [Search a 2d matrix](../go/binary-search/search-a-2d-matrix_test.go)                                                            | Поиск элемента в отсортированной 2D матрице                       | binary-search |
| [Guess number higher or lower](../go/binary-search/guess-number-higher-or-lower_test.go)                                        | Угадать число с использованием подсказок "выше" или "ниже"        | binary-search |
| [Search in rotated sorted array](../go/binary-search/search-in-rotated-sorted-array_test.go)                                    | Поиск в отсортированном массиве, который был повернут             | binary-search |
| [Search in rotated sorted array ii](../go/binary-search/search-in-rotated-sorted-array-ii_test.go)                              | Поиск в отсортированном повернутом массиве с дубликатами          | binary-search |
| [Find minimum in rotated sorted array](../go/binary-search/find-minimum-in-rotated-sorted-array_test.go)                        | Найти минимальный элемент в отсортированном повернутом массиве    | binary-search |
| [Two sums](../go/hash-tables/two-sums_test.go)                                                                                  | Найти два числа в массиве, сумма которых равна заданному значению | hash-tables   |
| [Single number](../go/hash-tables/single-number_test.go)                                                                        | Найти единственное число, которое встречается один раз в массиве  | hash-tables   |
